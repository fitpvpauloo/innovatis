...
/**
 * Data source for the fornecedorRead2 view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class fornecedorRead2DataSource extends DataSource<fornecedor> {
  data: fornecedor[] = EXAMPLE_DATA;
   ...
   */
  private getPagedData(data: fornecedor[]) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: fornecedor[]) {
